...
vi.mock('@/entrypoints/home/components/Sidebar', () => ({ Sidebar: () => null }));
vi.mock('@/entrypoints/home/components/Content', () => ({ Content: () => null }));
...
describe('home import reload', () => {
  it('收到 octane-import 事件 → 触发 loadWorkspaces reload', async () => {
    ...
    const { default: App } = await import('@/entrypoints/home/App');
